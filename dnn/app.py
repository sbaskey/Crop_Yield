...
CSV_FILE_PATH = "https://github.com/sbaskey/Crop_Yield/blob/master/dnn/odisha_dataset_DNN.csv,sep=',"  # Main dataset file
OTHER_CSV_FILE_PATH = "https://github.com/sbaskey/Crop_Yield/blob/master/dnn/soil_data.csv,sep=',"  # Secondary dataset file
